...
class PvxReport
{
    ...
    public function __construct($pvxAuth, $template)
    {
        ...
        $this->getReportObj = new PvxGetReport($pvxAuth->authenticate());
    ...
    public function whereDateBetween($columnName, $datetimeFrom, $datetimeTo = null)
    {
        ...
        if ($this->queryObj == "") {
            $this->queryObj = PVXQueryBuilder::type(new ReportType());
        }
    ...
    {
        $this->getReportObj->orderBy("[$field] $direction"); 
    ...
    public function first($columns = null)
    {
        ...
        if (empty($data)) throw new Exception('PVX returned data empty');
